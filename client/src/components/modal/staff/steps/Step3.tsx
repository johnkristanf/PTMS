...
export function DocumentStep3({ applicationID, applicantCode, completion_form_documents }: {
    applicationID: number
    applicantCode: string | undefined,
    completion_form_documents: string[]
}) {

    console.log("completion_form_documents (from DB): ", completion_form_documents);
    

    const [documents, setDocuments] = useState<string[]>(completion_form_documents || []);
    ...
    useEffect(() => {
        setDocuments(completion_form_documents || []);
  ...
  return (
    <div className="p-4">
        <h1 className="text-xl font-bold mb-4">Only Completion Form</h1>

        {/* Display List */}
        <div className="flex flex-col gap-2">
            {completion_form_documents.map((doc, index) => (
