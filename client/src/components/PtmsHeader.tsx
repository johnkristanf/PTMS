...
export function ApplicationNoteSubHeader(){
    return(
        <div className="fixed top-[75px] w-full bg-orange-600 h-[10vh] flex justify-center gap-2 z-[999]  text-white border border-t-white">
            {/* <h1 className='text-xl'>Note:</h1> */}

            <div className="flex gap-3">
                                <h1 className='text-center text-md w-full'>Note: Please secure copies of requirements 
