...
function ElectronicsCompletionPDF({ permitInfo, setPermitsInfo }: { 
        ...
        <>
            ...
            <div className="flex justify-center w-full h-[88%] fixed top-20">
                <div className="flex flex-col mt-3 items-center h-[95%] py-4 w-[55%] bg-white rounded-md">
                    <h1 className='font-bold text-3xl mb-3'>Electronics Completion PDF</h1>
...
export default ElectronicsCompletionPDF;
